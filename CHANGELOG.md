...
- New Settings › Family Sharing section brings parental controls, family dashboard sharing, and per-user permissions together under three tabs. Admins can control per person whether they can edit their dashboard and whether they see the global search and flows buttons. Everyone else sees it locked, and can choose to use a dashboard an admin has shared with them.
