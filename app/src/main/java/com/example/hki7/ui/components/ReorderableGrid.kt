...
fun <T> ReorderableGrid(
    ...
    val pointerModifier = if (canReorder) {
        Modifier.pointerInput(canReorder, isNested, dragHandleHeight, axis) {
            detectDragGesturesAfterLongPress(
                ...
                onDrag = { change, amount ->
                    if (draggedIndex != null) {
                        ...
                        val itemInView = gridState.layoutInfo.visibleItemsInfo.find { it.index == currentIndex }
                        ...
                        if (dragPosition != null) {
                            ...
                            if (targetIndex != null && targetIndex != currentIndex) {
                                val targetItem = gridState.layoutInfo.visibleItemsInfo.find { it.index == targetIndex }
