 ...
 * so the Charging + Battery Level entities update instantly on a power change, like the official HA
 * app's sensor receiver. Pushes one telemetry report; no foreground service needed.
 */
